...
echo "Where would you like to save the images?"
read -pr "--> " dir
echo ''
echo "How many wallpapers to download?"
read -pr "--> " wallnum
echo ''
echo "What resolution do you use? (e.g. 1920x1080)"
read -pr "--> " res 
echo ''
echo "What is the search query? (pretend like you're searching on wallhaven and not the CLI)"
read -pr "--> " searchterm
